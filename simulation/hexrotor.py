...
| naming (body at /body, rotors at /rotorN, joints rotor_1..rotor_6, articulation root on the top-level vehicle),
...
class HexrotorConfig:
    ...
    def __init__(self):
        ...
        # (six rotors ~9075 N), leaving sufficient control margin.
...
class Hexrotor(Vehicle):
    ...
    def handle_propeller_visual(self, rotor_number, force: float, articulation):
        ...
        joint = self.get_dc_interface().find_articulation_dof(
            articulation, "rotor_" + str(rotor_number + 1))
