...
class NonlinearControllerArm(Backend):
    ...
    def __init__(self,
        ...
        # Control effort: total thrust [N] and body torques [Nm]
        self.thrust_over_time = []
    ...
    def stop(self):
        ...
        statistics["thrust"] = np.array(self.thrust_over_time)      # total thrust u_1 [N]
        statistics["torque"] = np.vstack(self.torque_over_time)     # body torques tau [Nm], 3 cols
